...
def transform_pose_stamped(pose_stamped, transform_stamped) :
    xl = np.array([pose_stamped.pose.position.x, pose_stamped.pose.position.y, pose_stamped.pose.position.z], dtype=np.float64)
    ...
    out.pose.position.z = xa[2] + transform_stamped.transform.translation.z
